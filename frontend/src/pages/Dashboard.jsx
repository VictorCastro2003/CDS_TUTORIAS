...
const DashboardMejorado = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Obtener alumnos
      const resAlumnos = await fetchWithAuth("http://98.80.218.98:4000/api/alumnos", {
        headers: {
      ...
      const resEstadisticas = await fetchWithAuth(`http://98.80.218.98:4000/api/estadisticas${queryParams}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
      ...
      try {
        ...
        const resAlertasGlobal = await fetchWithAuth(`http://98.80.218.98:4000/api/alertas?estado=activa`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
          },
        ...
        const resCanalizacionesGlobal = await fetchWithAuth(`http://98.80.218.98:4000/api/canalizaciones`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
          },
