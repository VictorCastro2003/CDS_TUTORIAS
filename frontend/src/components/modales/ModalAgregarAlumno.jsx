...
const ModalAgregarAlumno = ({ 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetchWithAuth(`${API_BASE}/alumnos`, {
        method: 'POST',
        body: JSON.stringify({
      ...
      Swal.fire('Éxito', 'Alumno agregado al sistema correctamente', 'success');
      onClose();
      e.target.reset();
    } catch (error) {
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header bg-success text-white">
              <h5 className="modal-title">Agregar Nuevo Alumno al Sistema</h5>
              <button
                type="button"
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-footer">
                ...
                <button type="submit" className="btn btn-success">
                  <i className="fas fa-check-circle me-2"></i>Agregar Alumno
                </button>
              </div>
            </form>
          </div>
